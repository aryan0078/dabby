...
exports.welcomeMessages = [
  ...
  "Hmph, looks like **{{user}}**, another bruh, has joined.",
...
exports.levelUpMessages = [
  ...
  "E-eh? You leveled up? Well just because you're level **{{level}}** now, doesn't mean I'll like you more **{{user}}**... bruh.",
  ...
  "**{{user}}**, you bruh. Don't leave me behind now that you're level **{{level}}**.",
...
exports.levelMessages = [
  ...
  "Pfft, level **{{level}}**?",
  "**{{user}}** your level? It's **{{level}}**, bruh",
