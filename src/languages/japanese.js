...
module.exports = new Language(
  ...
  "日本語",
  {
    LANGUAGE_SET:
      "言語は日本語に設定されました\n\n**ノート**: 日本語の翻訳はまだ未完です",
    GUILD_ONLY:
      "馬鹿! このコマンドはサーバーでのみ使用できます。私のダイレクトメッセージでは何をしてるの?",
    OWNER_ONLY:
      "馬鹿! 何をしてんだよ? そのコマンドは私のマスターのためだけです",
    CHANNEL_NOT_FOUND: "そのチャンネルが見つかりません",
    ROLE_NOT_FOUND: "そのロールが存在しません",
    MENTION_REMINDER: (prefix) =>
      `こんにちは! コマンドのリストために\`${prefix}help\`を使用してください`,
    ...
    RELOAD_NOT_FOUND: ["何をしてるの? **{{command}}**は存在しません! 馬鹿!"],
    RELOAD_MISSING_ARG: [
    ...
    COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) =>
      `ミヤコのラウンジから (${prefix}supportを使って私たちに参加してください)`,
    COMMAND_SUPPORT_DESCRIPTION: "サポートサーバーに参加する",
    COMMAND_SUPPORT_TITLE: "ミヤコのラウンジを参加する",
    COMMAND_POKEMON_GUESS:
      "推測するには15秒があります。そのポケモンは誰ですか？英語の名前を入力してください",
    COMMAND_SLOTS_TITLE: "ミヤコのスロット",
    COMMAND_SLOTS_WIN: (points) =>
      `おめでとうございます! あなたは**${points}**を勝った！`,
    COMMAND_OWO: "OwO! 何これ?",
