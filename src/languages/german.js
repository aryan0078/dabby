...
module.exports = new Language(
  ...
  {
    LANGUAGE_SET:
      "Die Sprache wurde auf Deutsch gestellt.\n\n**Hinweis**: Die deutsche Übersetzung ist noch nicht vollständig",
    GUILD_ONLY:
      " Du kannst diesen Befehl nur auf einem Server benutzen. Was machst du in meinen DMs?",
    OWNER_ONLY: " Was tust du? Der Befehl ist nur für meinen Meister!",
    CHANNEL_NOT_FOUND: "Ich konnte den Channel nicht finden.",
    ROLE_NOT_FOUND: "Diese Rolle existiert nicht.",
    MENTION_REMINDER: (prefix) =>
      `Hi! Mit \`${prefix}help\` erhältst du eine Liste aller Befehle.`,
    ...
    WELCOME_MESSAGES: [
      ...
      "Hmph, scheint so als wäre **{{user}}**, ein weiterer bruh, beigetreten.",
    ...
    GOODBYE_MESSAGES: [
      ...
      "Awh, **{{user}}** hat den Server verlassen.. n-nicht das es mich interessieren würde! ",
      "**{{user}}-san**.... N-nein...",
    ...
    PING_MESSAGES: [
      ...
      "B-bruh, ich habe geantwortet... in nur **{{ms}}ms**.",
    ...
    LEVELUP_MESSAGES: [
      ...
      "E-eh? Du bist ein Level höhergekommen? Gut, du bist Level **{{level}}** jetzt, was nicht heißt das ich dich nun mehr mag, **{{user}}**... bruh.",
      ...
      "**{{user}}**, du bruh. Lass mich nicht zurück, du bist jetzt Level **{{level}}**.",
      ...
      "Wie kannst du Level **{{level}}** sein? D-du ",
      "B- Du bist jetzt Level **{{level}}**, jetzt sei frei! D-dummy...",
      "Du bist definitiv Level **{{level}}** du ",
    ],
    COMMAND_STATS_DESCRIPTION:
      "Hi, ich bin Miyako. Der All-in-One Unterhaltungsbot für deinen Server von meinem Meister Ravener#5796",
    ...
    COMMAND_CHOOSE_THINKING: (user) =>
      `${constants.typing} **${user}** denkt nach...`,
    COMMAND_8BALL_ASK: " Was möchtest du fragen?",
    ...
    COMMAND_KICK_BOT: " Warum möchtest du mich kicken?",
    COMMAND_KICK_SELF: " Warum möchtest du dich kicken?",
    COMMAND_KICK_OWNER: " Du kannst den Eigentümer nicht kicken.",
    ...
    COMMAND_POKEMON_GUESS:
      "Du hast 15 Sekunden zum erraten! Welches Pokèmon ist das?",
    COMMAND_SLOTS_TITLE: "Miyako Slots",
    COMMAND_SLOTS_WIN: (points) =>
      `Glückwunsch! Du hast **${points}** gewonnen!`,
    ...
    COMMAND_LYRICS_WHAT: " Nach welchem Song suchst du?",
