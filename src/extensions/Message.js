  ...
  (Message) =>
    class MiyakoMessage extends Message {
      ...
      sendLocale(key, value = [], options) {
        ...
        return this.send(
          APIMessage.transformOptions(this.language.get(key, ...value), options)
        );
      }
      ...
      success() {
        return this.react("519166152488910850").catch(() => null);
      }

      failure() {
        return this.react("519166256214048769").catch(() => null);
      }
